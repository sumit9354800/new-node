...
exports.getHome = (req, res, next) => {
  res.render('host/edit-home', { currentPage: 'addhome', title: 'Add Home', editing: false, isLoggedIn: req.isLoggedIn });
}
...
exports.getEditHome = (req, res, next) => {
  ...
  Home.findById(id).then((home) => {
    ...
    res.render('host/edit-home', { home, currentPage: 'host-home-list', title: 'Edit Home', editing: editing, isLoggedIn: req.isLoggedIn });
  })
}

exports.getHostHome = (req, res, next) => {
  Home.find().then((homeDetails) => {
    res.render('host/host-home-list', { homeDetails, currentPage: 'host-home-list', title: 'Hosted Home', isLoggedIn: req.isLoggedIn });
  })
}
